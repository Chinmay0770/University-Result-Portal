...
<head>
    ...
    <title>Faculty Register - DYPIU</title>
        ...
        <div class="main-wrap">
            <div class="box-container">
                ...
                <div class="form-wrap">
                    ...
                    <form action="../mysql/facultyRegistrationmysql.php" class="form" method="post">
                        <label for="name">Name</label></br>
                        <input type="text" name="name" id="" placeholder="Your full-name">
                        </br>
                        <label for="mail">Email</label></br>
                        <input type="email" name="mail" id="" placeholder="Your DYPIU Mail">
                        </br>
                ...
                <div class="login-with">
                    ...
                    <button class="btn1"><a href="facultylogin.php">Faculty Login</a></button>
                </div>
            </div>
        </div>
    </div>
