...
<head>
    ...
    <title>Student Login - DYPIU</title>
        ...
        <div class="main-wrap">
            <div class="box-container">
                ...
                <div class="form-wrap">
                    ...
                    <form action="../mysql/studentloginmysql.php" class="form" method="post">
                ...
                <div class="login-with">
                    <button class="btn1"><a href="Studentregistration.php">Student Register</a></button>
